...
import { QuizQuestionFormNoEngage } from './QuizQuestion/QuizQuestionFormNoEngage';
...
const QuizOneRequestDiscountNoEngage = ({ utms }) => {
  ...
  return (
    <>
      {activeSlide === 0 && <QuizTitleNoGifts beginQuiz={beginQuiz} />}
      {activeSlide === 1 && (
        <QuizQuestionLang
...
export default QuizOneRequestDiscountNoEngage;
