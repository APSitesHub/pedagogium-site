...
const TeacherControlPagePl = () => {
  ...
  useEffect(() => {
    ...
    const getTeachers = async () => {
      ...
      try {
        if (isUserAdmin) {
          const response = await axios.get('/teachers/pl');
    ...
    const getReviews = async () => {
      ...
      try {
        if (isUserAdmin) {
          const response = await axios.get('/speakingusers/admin/pl');
...
export default TeacherControlPagePl;
