...
const TeacherControlPageEn = () => {
  ...
  useEffect(() => {
    ...
    const getTeachers = async () => {
      ...
      try {
        if (isUserAdmin) {
          const response = await axios.get('/teachers/en');
    ...
    const getReviews = async () => {
      ...
      try {
        if (isUserAdmin) {
          const response = await axios.get('/speakingusers/admin/en');
...
export default TeacherControlPageEn;
